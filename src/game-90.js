...
(function(){
 ...
 function renderResidentJournalV90(){
  ...
  content.innerHTML=`<section class="resident-journal"><h3>你現在的狀態</h3>${journalPlayerStatusV90()}<h3>昨天與最近做過的事</h3>${journalPersonalEventsV90()}<h3>你聽到的</h3>${journalHeardV90()}<h3>廣播回顧</h3>${journalBroadcastV90()}<h3>你的感覺</h3><div>${journalFeelingV90()}</div></section>`;
 }
