...
await waitFor(()=>evaluate(`typeof qaStateV84==='function'&&typeof ensureExplorationV113==='function'&&typeof renderMapV118==='function'&&window.__SCORCH_ENTRY_ACTIVE===false`),30000);
const result=await evaluate(`(()=>{
 ...
 state.explorationV118={selected:null,explored:['base'],observed:{base:true}};
 ...
 const ids=[...map.querySelectorAll('[data-select-v118]')].map(x=>x.dataset.selectV118);
 const warehouseNode=map.querySelector('[data-select-v118="warehouse"]');
 ...
 return {
  ...
  plannerHidden:!!planner&&planner.hidden===true,
...
assert(result.plannerHidden,'legacy planner remained visible');
