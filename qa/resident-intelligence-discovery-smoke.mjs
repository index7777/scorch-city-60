...
assert(snap.known&&snap.source==='testimony'&&snap.reliability==='low'&&snap.verified===false,'NPC testimony intelligence metadata is wrong');assert(snap.counts[0]===50&&snap.counts[1]===12&&snap.counts[2]===3&&snap.counts[3]===30,'Batch 6 foundation counts changed unexpectedly');
